!(function () {
  ...
  !(function (e) {
    ...
    function t(n) {
      (n = n || {}),
        (this.defaultProtocol = n.hasOwnProperty("defaultProtocol")
          ? n.defaultProtocol
          : h.defaultProtocol),
        (this.events = n.hasOwnProperty("events") ? n.events : h.events),
        (this.format = n.hasOwnProperty("format") ? n.format : h.format),
        (this.formatHref = n.hasOwnProperty("formatHref")
          ? n.formatHref
          : h.formatHref),
        (this.nl2br = n.hasOwnProperty("nl2br") ? n.nl2br : h.nl2br),
        (this.tagName = n.hasOwnProperty("tagName") ? n.tagName : h.tagName),
        (this.target = n.hasOwnProperty("target") ? n.target : h.target),
        (this.validate = n.hasOwnProperty("validate")
          ? n.validate
          : h.validate),
        (this.ignoreTags = []),
        (this.attributes = n.attributes || n.linkAttributes || h.attributes),
        (this.className = n.hasOwnProperty("className")
          ? n.className
          : n.linkClass || h.className);
      for (
        var e = n.hasOwnProperty("ignoreTags") ? n.ignoreTags : h.ignoreTags,
          a = 0;
        a < e.length;
        a++
      )
    ...
    function c(n, e, a, t) {
      for (
        var o = 0, r = n.length, i = e, s = [], c = void 0;
        o < r && (c = i.next(n[o]));
    ...
    t.prototype = {
      ...
      get: function (e, a, t) {
        ...
        switch ("undefined" == typeof r ? "undefined" : n(r)) {
          ...
          case "object":
            return (
              (o = r.hasOwnProperty(t.type) ? r[t.type] : h[e]),
              "function" == typeof o ? o(a, t.type) : o
            );
        }
        return r;
      },
    ...
    var b = Object.freeze({ defaults: h, Options: t, contains: o }),
      p = s();
    p.prototype = {
      defaultTransition: !1,
      on: function (n, e) {
      ...
      f = a(p, s(), {
        jump: function (n) {
          var e =
            ...
            a = this.next(new n(""));
          return (
            a === this.defaultTransition
              ? ((a = new this.constructor(e)), this.on(n, a))
              : e && (a.T = e),
            a
          );
        },
    ...
    var yn = function (n) {
        for (
          var e = n.replace(/[A-Z]/g, function (n) {
      ...
      vn = V,
      kn = Object.freeze({ State: m, TOKENS: Y, run: yn, start: vn }),
      wn = l();
    wn.prototype = {
      type: "token",
      isLink: !1,
    ...
    var jn = a(wn, l(), { type: "email", isLink: !0 }),
      zn = a(wn, l(), {
        type: "email",
        isLink: !0,
        toHref: function () {
      ...
      le = Tn(),
      ue = Tn(qn);
    An.on(z, ue).on(S, Ln).on(T, Pn).on(L, En),
      Ln.on(L, En),
      En.on(L, Cn),
      An.on(C, Rn).on(x, Rn).on(j, Bn).on(O, Rn),
      Cn.on(C, Dn).on(x, Dn).on(O, Dn).on(j, Dn),
      Rn.on(k, Hn),
      ne.on(k, ee),
      Hn.on(C, Bn).on(x, Rn).on(O, Rn).on(j, Rn),
      ee.on(C, ae).on(x, ne).on(O, ne).on(j, ne),
      Bn.on(k, Hn),
      ae.on(k, ee),
      Bn.on(v, Un).on(L, Dn),
      Un.on(O, Mn),
    ...
    Dn.on(H, Kn).on(B, _n).on(U, Gn).on(M, Yn),
      In.on(H, Kn).on(B, _n).on(U, Gn).on(M, Yn),
      Kn.on(D, Dn),
      _n.on(I, Dn),
      Gn.on(K, Dn),
      Yn.on(_, Dn),
      ...
      Dn.on(he, In),
      In.on(he, In),
      Pn.on(C, re).on(x, re).on(O, re).on(j, re),
      re.on(ge, re).on(he, ie),
      ie.on(ge, re).on(he, ie);
    var be = [x, O, q, N, A, P, E, G, C];
    Rn.on(be, se).on(y, ce),
      Bn.on(be, se).on(y, ce),
      Hn.on(be, se),
      se.on(be, se).on(y, ce).on(k, le),
      le.on(be, se),
      ce.on(C, ne).on(x, ne).on(j, ae);
    var pe = function (n) {
        for (var e = n.length, a = 0, t = [], o = []; a < e; ) {
          for (
            var r = An, i = null, s = null, c = 0, l = null, u = -1;
            a < e && !(i = r.next(n[a]));
          ...
          for (; a < e && (s = i || r.next(n[a])); )
            (i = null),
              (r = s),
              r.accepts() ? ((u = 0), (l = r)) : u >= 0 && u++,
              a++,
              c++;
          if (u < 0) for (var g = a - c; g < a; g++) o.push(n[g]);
          else {
